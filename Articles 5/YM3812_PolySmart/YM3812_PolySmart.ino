...
now with polyphonic MIDI functionality. This code pairs with
an article and YouTube video. Where we implement a more advancde
...
void handleNoteOn( byte channel, byte midiNote, byte velocity ){               // Handle MIDI Note On Events
  PROC_YM3812.noteOn( midiNote );                                              // Play midiNote
}

void handleNoteOff( byte channel, byte midiNote, byte velocity ){              // Handle MIDI Note Off Events
  PROC_YM3812.noteOff( midiNote );                                             // Turn off midiNote
}
