...
function processOP2File( fileName, data ){
  ...
  patchList.map( (patch, inst) => {
    ...
    outStr += `0x${toHex( ((patch.v1_op1_adr_80   >> 4) & 0b00001111 )<<3)},`; // PATCH_SUSTAIN_LEVEL
    ...
    outStr += `0x${toHex( ((patch.v1_op2_adr_80   >> 4) & 0b00001111 )<<3)},`; // PATCH_SUSTAIN_LEVEL
    outStr += "0x00,";                                                         // PATCH_SUSTAIN_DECAY
    ...
    outStr += `0x${toHex( ((patch.v2_op1_adr_80   >> 4) & 0b00001111 )<<3)},`; // PATCH_SUSTAIN_LEVEL
    outStr += "0x00,";                                                         // PATCH_SUSTAIN_DECAY
    ...
    outStr += `0x${toHex( ((patch.v2_op2_adr_80   >> 4) & 0b00001111 )<<3)},`; // PATCH_SUSTAIN_LEVEL
    outStr += "0x00,";                                                         // PATCH_SUSTAIN_DECAY
