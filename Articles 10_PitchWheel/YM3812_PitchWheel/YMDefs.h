...
// PITCH BEND MIDI CONSTANT

#define PITCH_WHEEL_RANGE 0x3FFF
...
struct YM_Channel{
  ...
  uint8_t       velocity   = 127;                                                                 // The velocity of the note
  ...
  int8_t   bend_note;                                                                              // Pitch Bend note offset
  uint16_t bend_rem;                                                                               // Pitch Bend sub-note offset
